...
fun UnitConverter(){
    ...
    Column (
        ...
        // Here are the UI elements will be stacked stacked below each other
        Text(text = "Unit Converter",  style = MaterialTheme.typography.headlineLarge)
        Spacer(modifier = Modifier.height(16.dp))
        OutlinedTextField(value = inputValue, onValueChange ={
            inputValue = it
            convertUnits()
            //Here goes what should happen the value of our OutlinedTextField
        } ,
        ...
        Row {
            ...
            // Here are the UI elements will be stacked stacked next each other
